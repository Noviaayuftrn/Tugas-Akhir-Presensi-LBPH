              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('class.update', $class->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <label>Nama Kelas</label><br>
                        <input type="text" class="form-control" name="nama_kelas" placeholder="Nama" value="{{ old('nama_kelas', $class->name) }}">
                      ...
                      <a href="{{ route('class.index') }}" class="btn btn-danger" style="color: white;">Kembali</a>
                    </form>
                  </div>
                </div>
              </div>
