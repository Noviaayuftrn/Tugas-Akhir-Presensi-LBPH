                  ...
                  <div class="card-body">
                    ...
                    <form action="{{ route('major.update', $major) }}" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_jurusan" placeholder="Nama" value="{{ old('nama_jurusan', $major->nama_jurusan) }}">
                      </div>
                      <button type="submit" class="btn btn-primary me-2">Simpan</button>
                      <a href="{{ route('major.index') }}" class="btn btn-danger" style="color: white;">Kembali</a>
                    </form>
                  </div>
                </div>
              </div>
